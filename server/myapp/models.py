...
class Thing(models.Model):
    ...
    major = models.CharField(max_length=100, blank=True, null=True)  # 擅长
    zhicheng = models.CharField(max_length=100, blank=True, null=True)  # 职称
...
class Nurse(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    classification = models.ForeignKey(Classification, on_delete=models.CASCADE, blank=True, null=True,
                                       related_name='classification_nurse')
    title = models.CharField(max_length=30, blank=True, null=True)
    sex = models.CharField(max_length=30, blank=True, null=True)
    age = models.CharField(max_length=30, blank=True, null=True)
    major = models.CharField(max_length=100, blank=True, null=True)  # 擅长
...
class Stay(models.Model):
    id = models.BigAutoField(primary_key=True)
    classification = models.ForeignKey(Classification, on_delete=models.CASCADE, blank=True, null=True,
                                       related_name='classification_stay')
    title = models.CharField(max_length=30, blank=True, null=True)  # 患者姓名
    sex = models.CharField(max_length=30, blank=True, null=True)
    age = models.CharField(max_length=30, blank=True, null=True)
    remark = models.CharField(max_length=30, blank=True, null=True)
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Medical(models.Model):
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=30, blank=True, null=True)  # 名称
    treatment = models.CharField(max_length=30, blank=True, null=True)  # 主治
