...
> 基于django+mysql开发的医院门诊管理系统，本文档包括功能说明、数据库设计、开发过程。学习过程遇到问题可以咨询作者：lengqin1024（微信）

## 功能说明

- 医生管理（包括医生的新增、查询、删除、编辑功能）
- 科室管理（包括科室的新增、查询、删除、编辑功能）
- 住院管理（包括住院信息的新增、查询、删除、编辑功能）
- 药品管理（包括药物的新增、查询、删除、编辑功能）
- 护士管理（包括护士的新增、查询、删除、编辑功能）
...
无论是用户管理、医生管理、护士管理等功能都是基于django的restframework框架开发的，开发流程是：
- 第一步：编写model模型
- 第二步：编写序列化器
- 第三步：编写view视图
- 第四步：配置url接口地址
