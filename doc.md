...
一直想做一款医院门诊医疗管理系统，看了很多优秀的开源项目但是发现没有合适的。于是利用空闲休息时间开始自己写了一套管理系统。
学习过程中遇到问题可以咨询微信：lengqin1024 或者发Email: kefu308@gmail.com

## 在线体验


- 代码下载：https://github.com/geeeeeeeek/python_hospital
- 演示地址：http://hospital.gitapp.cn/
...
- 医生管理：管理系统可以录入、修改和查询医生的基本信息，如医生名称、特长、备注等。
- 科室管理：科室信息的增删改查。
- 药品管理：药品信息的增删改查。
- 住院管理：住院信息的增删改查。
- 护士管理：护士信息的增删改查。
...
在医生管理系统中，需要存储和管理医生信息、评论信息、分类信息、标签信息、用户信息、通知信息、日志信息。
...
无论是医生管理、用户管理、科室管理、护士管理、日志管理等功能都是基于springboot+vue框架开发的，开发流程是：
...
下面用医生管理功能来演绎这个流程，其它的管理功能都是这个流程。
        ...
        <div style="padding-right: 16px; max-height: 480px; overflow-x: hidden; overflow-y: auto">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="科室名称" name="classification">
                  <a-select
                    placeholder="请选择"
                    allowClear
                    :options="modal.cData"
              ...
              <a-col span="12">
                <a-form-item label="职称" name="zhicheng">
                  <a-input placeholder="请输入" v-model:value="modal.form.zhicheng" />
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="状态" name="status">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.status">
                    <a-select-option key="0" value="0">在职</a-select-option>
                    <a-select-option key="1" value="1">退休</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
...
这就是医生管理功能的实现流程，其它的功能管理实现一模一样的。按照这个流程编写即可。
